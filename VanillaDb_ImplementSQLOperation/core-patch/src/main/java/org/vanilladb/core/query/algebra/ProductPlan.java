...
public class ProductPlan implements Plan {
	...
	// as3
	public String getPlanInfo(String info) {
		String info_next = "\t"+ info;
		String output = info + "->ProductPlan  (#blks=" + blocksAccessed() + ", #recs=" 
				 + recordsOutput() + ")\n" + p1.getPlanInfo(info_next) + p2.getPlanInfo(info_next);
		return output;
	}
	// as3
}
